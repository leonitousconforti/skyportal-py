...
def fetch_obj_position(  # noqa: PLR0913 -- mirrors the endpoint's query parameters
    ...
    *,
    ...
    return ObjPosition.model_validate(unwrap(response))
...
def fetch_super_obj(client: httpx.Client, super_obj_id: int) -> SuperObj:
    ...
    return SuperObj.model_validate(unwrap(response))
...
def fetch_super_objs(
    ...
    *,
    ...
    return [SuperObj.model_validate(item) for item in unwrap(response)]
