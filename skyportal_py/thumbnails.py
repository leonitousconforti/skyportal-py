...
class ThumbnailPathReport(BaseModel):
...
def fetch_thumbnail(client: httpx.Client, thumbnail_id: int) -> Thumbnail:
    ...
    return Thumbnail.model_validate(unwrap(response))
...
def fetch_thumbnail_paths(
    ...
    *,
    ...
    types : list of str, optional
        Thumbnail types to check. The server defaults to
    ...
    return ThumbnailPathReport.model_validate(unwrap(response))
