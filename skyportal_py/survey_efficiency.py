...
class SurveyEfficiencyForObservations(BaseModel):
    """A survey efficiency analysis of executed observations."""
...
class SurveyEfficiencyForObservationPlan(BaseModel):
    """A survey efficiency analysis of a planned observation sequence."""
...
class DefaultSurveyEfficiencyRequest(BaseModel):
    """A default (automated) survey efficiency request."""
