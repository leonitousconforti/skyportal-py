...
def fetch_observation_plan(
    ...
    *,
...
) -> ObservationPlanRequest | dict[str, Any]:
    ...
    rubin_format : bool, optional
        ...
        format instead of an :class:`ObservationPlanRequest`. Only takes
    ...
    if rubin_format and include_planned_observations:
        return data
    return ObservationPlanRequest.model_validate(data)
...
def fetch_observation_plans(  # noqa: PLR0913 -- mirrors the endpoint's query parameters
    ...
    *,
    ...
    return ObservationPlanRequestsPage.model_validate(unwrap(response))
...
def delete_observation_plan_queue(
    ...
    return ObservationPlanRequest.model_validate(unwrap(response))
...
def fetch_observation_plan_geojson(
    ...
    return ObservationPlanGeoJSON.model_validate(unwrap(response))
...
def fetch_default_observation_plan(
    ...
    return DefaultObservationPlanRequest.model_validate(unwrap(response))


def fetch_default_observation_plans(
    client: httpx.Client,
) -> list[DefaultObservationPlanRequest]:
    ...
    return [
        DefaultObservationPlanRequest.model_validate(request)
...
def fetch_allocation_observation_plans(  # noqa: PLR0913 -- mirrors the endpoint's query parameters
    ...
    *,
    ...
    return AllocationObservationPlansPage.model_validate(unwrap(response))
